...
public class SNP {
	...
	public static Classifier getClassifier(String name){
		...
		switch (name){
			...
			default:
				System.out.println("目前只支持rf(randomForst),j488");
		}
		return classify;
	}
	...
	public static void main(String[] args) throws IOException {
		...
		//String command="-i D://工作//nsSNP_rawData//humvar_dataset.csv -o D://工作//nsSNP_rawData//out.arff -n 3";
		...
		for(int i =1; i<100 ; i++){
			...
			String command="-i D://工作//nsSNP_rawData//humvar_dataset.csv -o D://工作//nsSNP_rawData//sng -n 3";
			String com[] = command.split(" ");
			n = Integer.valueOf(i);
